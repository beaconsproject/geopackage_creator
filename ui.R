                   ...
                   dashboardSidebar(
                     ...
                     conditionalPanel(
                       ...
                       radioButtons("sourceSA", "Select file format:",
                                    ...
                                    inline = TRUE),
                       fileInput("upload_sa", "Upload study area:", multiple = TRUE, accept=c('.shp','.dbf','.sbn','.sbx','.shx','.prj','.cpg', '.gpkg'))
                     ),
                     conditionalPanel(
                     ...
                     conditionalPanel(
                       ...
                       sliderInput("minmax", label="Range of fires to include:", min=1900, max=2025, value=c(1946, 2025)),
