...
The application provides two sources by default: NRCAN Natural Burned Area Composite (https://cwfis.cfs.nrcan.gc.ca/downloads/nbac/) and NRCAN National Fire Database Perimeters (https://cwfis.cfs.nrcan.gc.ca/downloads/nfdb/fire_poly/current_version/)
